...
import { FscContext } from "../context/FscContext";
...
const Sidebar = () => {
  ...
  const { isAuthenticated, user, Moralis, logout } = useContext(FscContext);
  return (
      ...
      <div className={styles.menu}>
        <Link href="/">
          <div className={styles.menuItem}>
            <img src="" height={30} width={30} className={styles.amazonLogo} />
            My Amazon
            <br /> Board
          </div>
        </Link>
